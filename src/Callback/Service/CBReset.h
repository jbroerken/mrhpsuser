...
public:
     ...
     *  Default constructor.
     *
     *  \param p_Content The content information to reset on callback.
     */
    
    CBReset(std::shared_ptr<Content>& p_Content) noexcept;
    ...
    /**
     *  Perform a callback with a recieved service reset event.
     *
     *  \param p_Event The recieved service reset event.
